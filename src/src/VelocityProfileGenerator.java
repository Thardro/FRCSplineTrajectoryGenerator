...
public class VelocityProfileGenerator {
	...
	public Trajectory calculateProfile() {
		
		Trajectory trajectory = new Trajectory(totalPoints + 1);
		...
		for(int i = 0; i <= totalPoints; i++) {
			...
			trajectory.getPoint(currentPoint).setDT(itp);
			trajectory.getPoint(currentPoint).setPosition(currentPosition);
			trajectory.getPoint(currentPoint).setVelocity(currentVelocity);
